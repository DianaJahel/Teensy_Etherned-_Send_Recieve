...
const int CMD_DISTANCE_DATA_TRANSFER = 0x0006;  //Wie sieht ein Datenpaket aus? (übertragene Informationen und deren Reihenfolge, Details an der Stelle, wo der Befehl dekodiert wird)
const int CMD_FREQUENCY = 0x0007; 
...
const int CMD_DISTANCE_DATA_TRANSFER_ACCEPTED = 0x8006;
const int CMD_FREQUENCY_ACCEPTED = 0x8007;
